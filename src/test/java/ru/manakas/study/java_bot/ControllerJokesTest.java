...
import ru.manakas.study.java_bot.Controller.Controller;
...
class JokeControllerTest {
    ...
    void getJokeById() throws Exception {
        ModelJokes joke = new ModelJokes(1L, "Какой-то анекдот", null, null);
    ...
    void changeJoke() throws Exception {
        ModelJokes joke = new ModelJokes(1L, "Изменённый анекдот", null, null);
    ...
    void changeJokeNotFound() throws Exception {
        ModelJokes joke = new ModelJokes(2L, "Изменённый анекдот", null, null);
